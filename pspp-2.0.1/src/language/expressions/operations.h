...
typedef enum  {
    ...
    n_OP_atom = OP_atom_last - OP_atom_first + 1,
    ...
    n_OP_function = OP_function_last - OP_function_first + 1,
    ...
    n_OP_operator = OP_operator_last - OP_operator_first + 1,

    OP_composite_first = OP_function_first,
    OP_composite_last = OP_operator_last,
    n_OP_composite = OP_composite_last - OP_composite_first + 1,

    OP_first = OP_atom_first,
    OP_last = OP_composite_last,
    n_OP = OP_last - OP_first + 1
  }
