...
*/
#include "version.h"
const char bare_version[] = "2.0.1";
const char version[] = "GNU pspp 2.0.1";
const char announced_version[] = "GNU pspp 2.0.1";
const char host_system[] = "aarch64-apple-darwin23.5.0";
const char build_system[] = "aarch64-apple-darwin23.5.0";
